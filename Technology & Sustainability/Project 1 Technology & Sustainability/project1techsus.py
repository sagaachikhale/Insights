...
# Sort the countries by AI Preparedness Index (descending for top, ascending for bottom)
...
# Sort the countries by AI GDP per capita (current US$)(descending for top, ascending for bottom)
...
# Display the correlations of 'AI preparedness Index' with others
...
# Top 10 countries by AI Preparedness Index
...
# Top 10 countries by Digitial Infrastructure
...
# Top 10 countries by Regulation and Ethics
...
sns.regplot(
    data=df,
    x='Human Capital and Labor Market Policies',
    y='AI preparedness Index',
    scatter_kws={'alpha':0.6},
    line_kws={'color':'red'}
)
...
# Top 10 countries by Human Capital and Labor Market Policies
...
sns.regplot(
    data=df,
    x='Innovation and Economic Integration',
    y='AI preparedness Index',
    scatter_kws={'alpha':0.6},
    line_kws={'color':'red'}
)
...
# Display the correlations of 'GDP per capita (current US$)' with others
